...
public class BalanceEnquiryForm {
	...
	public BalanceEnquiryForm(WebDriver driver) {
		this.driver = driver;
		PageFactory.initElements(driver, this);
		waitHelper = new WaitHelper(driver);
		waitHelper.waitForElement(driver, BalanceEnquiry,ObjectRepo.reader.getExplicitWait());
